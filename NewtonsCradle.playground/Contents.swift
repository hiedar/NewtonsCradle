...
let color1 = UIColor(red: 0.8779790997505188, green: 0.3812967836856842, blue: 0.5770481824874878, alpha: 1.0)
let color2 = UIColor(red: 0.2202886641025543, green: 0.7022308707237244, blue: 0.9593387842178345, alpha: 1.0)
let color3 = UIColor(red: 0.9166661500930786, green: 0.4121252298355103, blue: 0.2839399874210358, alpha: 1.0)
let color4 = UIColor(red: 0.521954357624054, green: 0.7994346618652344, blue: 0.3460423350334167, alpha: 1.0)

let newtonsCradle = NewtonsCradle(colors: [color1, color2, color3, color4])
/*:
### Size and spacing
